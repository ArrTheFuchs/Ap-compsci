...
public class Pig{
    ...
    public static String translateSentence( String s) {
        ...
        public static void main( String[] args ) {
            //System.out.println(translator("Pig,.") + "......expecting Igpay,.");
            //System.out.println(translator("Unicorn") + "......expecting Unicornyay,.");
            System.out.println(translator("All hail, Lady Bartholomew!") + "......expecting  Allyay ailhay, adyLay artholomewBay!");
            System.out.println(translateSentence("Pig,.") + "......expecting Igpay,.");
            System.out.println(translateSentence("All hail, Lady Bartholomew!") + "......Allyay ailhay, adyLay artholomewBay!.");
            System.out.println(translateSentence("Hey Jing, how are you?") + "......Eyhay Ingjay, owhay areway ouyay?");
